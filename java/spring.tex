...
\begin{itemize}
    ...
    \item RANDOM\_PORT: Loads a WebServerApplicationContext and provides a real web environment. Embedded servers are started and listen on a random port. The @LocalServerPort annotation can be used to inject the actual port used into your test.
...
Auto-configured capabilities include: a templating engine, Jackson, caching.
