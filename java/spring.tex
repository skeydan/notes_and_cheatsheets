...
\begin{itemize}
    ...
    \item Any destroy method in a bean implementation class implementing the DisposableBean interface is invoked.
...
\subsection{Creating Your Own Auto-configuration}
