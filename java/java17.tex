...
\subsection{Method references}
    ...
    Like lambdas, method references use type inference.
...
\subsubsection{Sealed Classes}
    ...
    \end{lstlisting}
     ...
     In an \textit{unnamed} module, the sealed class and its subclasses must be within the same package. If they are in same file or the extension is nested, no permits clause is needed (but the extends still is!).
