...
\subsubsection{Sealed Classes}
    ...
    \end{lstlisting}
     ...
     The exact rule is as given in the following two statements:
     1.
     2.
    ...
    \begin{itemize}
        \item  If the permitting and permitted classes are in same file, or if the permitted is nested, no permits clause is needed (but the extends still is!).
